...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', '-o', type=str, default=os.path.join(MOVIE_TRANSLATION_DATASET_DIR, 'exchanged_videos'), help="output_dir to save the videos in: def: '<path/to/MOVIE_TRANSLATION>/exchanged_videos'")
