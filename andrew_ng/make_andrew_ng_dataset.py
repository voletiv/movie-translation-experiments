...
def extract_person_face_frames(video_file, out_dir, person_name,
                               ...
                               save_faces=False, save_with_blackened_mouths_and_polygon=True):
    ...
    E.g.:
    -----
    extract_person_face_frames('/shared/fusor/home/voleti.vikram/ANDREW_NG/videos/01_small.mp4',
                               '/shared/fusor/home/voleti.vikram/ANDREW_NG/videos/a',
    ...
    @param dlib_detector dlib.get_frontal_face_detector() - optional, useful in case of
    running this function on multiple <video_file>s in a loop
    ...
    can be downloaded from http://dlib.net/files/shape_predictor_68_face_landmarks.dat
    or http://dlib.net/files/shape_predictor_5_face_landmarks.dat; for more details see
    ...
    http://dlib.net/files/dlib_face_recognition_resnet_model_v1.dat; for more details,
    ...
    http://dlib.net/files/shape_predictor_68_face_landmarks.dat or
    http://dlib.net/files/shape_predictor_5_face_landmarks.dat; for more details see
    http://dlib.net/face_landmark_detection.py.html

    @param face_rec_model_path Path to dlib_face_recognition_resnet_model_v1.dat, which
    can be downloaded from http://dlib.net/files/dlib_face_recognition_resnet_model_v1.dat;
    ...
    @param save_with_blackened_mouths_and_polygon Understandable
    """
    ...
    if person_face_descriptor is None:
        ...
        ref_face = dlib_detector(ref_frame, 1)[0]
        ref_shape = dlib_predictor(ref_frame, ref_face)
    ...
    for frame_number, frame in enumerate(tqdm(video_frames)):
        ...
        if detect_face_shapes:
            ...
            face_shapes_in_frame = utils.get_all_face_shapes(frame, dlib_detector, dlib_predictor)

            # Append to list of face shapes in frames
            face_shapes_in_frames_all_persons.append([video_frame_name] + face_shapes_in_frame)
        ...
        if person_landmarks_in_frame is not None:
            ...
            if save_with_blackened_mouths_and_polygon:
